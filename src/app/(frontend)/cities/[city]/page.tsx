...
export default function CityDetailPage({ params }: { params: { city: string } }) {
  ...
  const cityDestinations = destinations.filter(d => d.city.toLowerCase() === city.name.toLowerCase())
            ...
            {city.highlights.map((h, i) => (
              <div
                ...
                style={{
                  ...
                  padding:      '16px 20px',
                  borderRadius: '12px',
                  background:   hoveredHighlight === h ? '#fff' : '#fff',
      ...
      <div style={{ background: '#0f172a', padding: '64px 0', textAlign: 'center' }}>
        ...
        <div style={{ display: 'flex', gap: '12px', justifyContent: 'center' }}>
          <Link href="/plan" style={{
            ...
            fontSize: '14px', fontWeight: 600, boxShadow: '0 1px 3px rgba(0,0,0,.1)',
          }}>
            Plan Your Trip
          </Link>
          <Link href={`/explore?region=${city.region}`} style={{
