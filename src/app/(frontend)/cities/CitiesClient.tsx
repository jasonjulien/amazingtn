...
export default function CitiesClient({ cities }: { cities: CityData[] }) {
  ...
  return (
    <div style={{ background: '#fafaf9', minHeight: '100vh' }}>
      ...
      <div style={{
        ...
        <div style={{ maxWidth: '1440px', margin: '0 auto', padding: '16px 48px', display: 'flex', gap: '8px', alignItems: 'center' }}>
