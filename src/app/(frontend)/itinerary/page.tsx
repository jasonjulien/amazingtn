    ...
    <div style={{ background: '#fafaf9', minHeight: '100vh' }}>
      ...
      >
        <div style={{ maxWidth: '1440px', margin: '0 auto' }}>
          ...
          >
            Add destinations as you explore the site, then drag stops between days to organize your
            trip.
          </p>
        </div>
      </div>
                      ...
                      days.length > 1
                        ? () => {
                            ...
                            if (activeDayId === day.id)
                              setActiveDay(days.find((d) => d.id !== day.id)?.id ?? '')
                          }
                        : undefined
                    }
                  />
                ...
                (currentDay.stops.length === 0 ? (
                  ...
                  >
                    <p style={{ fontSize: '15px', marginBottom: '8px' }}>
                      No stops for {currentDay.label} yet.
                    </p>
                    <p style={{ fontSize: '13px' }}>
                      Browse{' '}
                      <Link href="/explore" style={{ color: '#f59e0b' }}>
                        destinations
                      </Link>{' '}
                      and hit + Add, or drag a stop from another day onto this tab.
                    </p>
                  </div>
                ) : (
                ...
                >
                  ...
                  <SummaryRow
                    ...
                    value={
                      regions.length === 0
                        ? '—'
                        : regions.map((r) => regionLabel[r] ?? r).join(', ')
                    }
                    small
                  />
                  <div
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '4px', color: '#94a3b8' }}>
          ...
          <span style={{ fontSize: '12px' }}>
            {stop.city}, {regionLabel[stop.region] ?? stop.region}
          </span>
        </div>
      </div>
...
function EmptyState() {
  return (
    <div style={{ textAlign: 'center', padding: '80px 0' }}>
      ...
      >
        Browse destinations and click <strong>+ Add</strong> on any card to start building your
        trip.
      </p>
      <Link
        href="/explore"
