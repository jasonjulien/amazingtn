...
export default function RegionDetailClient({
  ...
  return (
    <div style={{ background: '#fafaf9', minHeight: '100vh' }}>
      ...
      {/* ── Hero ── */}
      <div
        style={{ position: 'relative', height: '720px', overflow: 'hidden', background: '#0f172a' }}
      >
        <img
          src={mediaUrl(region.heroImage)}
          alt={region.label}
          style={{
            position: 'absolute',
            inset: 0,
        ...
        <div
          style={{
            ...
            inset: 0,
            background:
              'linear-gradient(to top, #0f172a 0%, rgba(15,23,42,0.5) 50%, rgba(15,23,42,0.3) 100%)',
          }}
        />
        ...
        >
          {region.highlights.map((h, i) => (
            <div key={h} style={{ textAlign: 'center' }}>
              ...
              <h3
                style={{ fontSize: '17px', fontWeight: 700, color: '#1e293b', marginBottom: '6px' }}
              >
                {h}
              </h3>
            </div>
        ...
        <div style={{ maxWidth: '1440px', margin: '0 auto', padding: '0 48px' }}>
          ...
          >
            <div>
              ...
              <h2
                style={{ fontSize: '34px', fontWeight: 400, color: '#fff', marginBottom: '32px' }}
              >
              ...
              <Link
                href={`/explore?region=${regionSlug}`}
                style={{
                  display: 'inline-flex',
                  alignItems: 'center',
                  gap: '8px',
      ...
      {regionDestinations.length > 0 && (
        <div style={{ background: '#fafaf9', padding: '80px 0' }}>
          <div style={{ maxWidth: '1440px', margin: '0 auto', padding: '0 48px' }}>
            <h2
              style={{ fontSize: '34px', fontWeight: 400, color: '#1e293b', marginBottom: '32px' }}
            >
