  ...
  return (
    <div style={{
      ...
      <div style={{
        position:   'absolute',
        inset:      0,
        background: 'linear-gradient(to bottom, rgba(15,23,42,0.5) 0%, rgba(15,23,42,0.35) 50%, rgba(15,23,42,0.75) 100%)',
      }} />
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '24px' }}>
          ...
          <span style={{
            fontSize: '14px', color: '#fcd34d',
            textTransform: 'uppercase', letterSpacing: '4.2px', fontWeight: 400,
          }}>
            The Volunteer State
          </span>
          <div style={{ width: '16px', height: '1px', background: '#fbbf24' }} />
        ...
        <h1 style={{
          ...
          letterSpacing: '-2.4px', marginBottom: '24px',
        }}>
          Discover<br />
        ...
        <p style={{
          ...
          maxWidth: '650px', lineHeight: 1.65, marginBottom: '40px',
        }}>
      ...
      <div style={{
        ...
        <div style={{
          maxWidth: '1440px', width: '100%', padding: '0 48px',
          display: 'flex', justifyContent: 'space-around', alignItems: 'center',
        }}>
          {stats.map((s, i) => (
            <div key={i} style={{ textAlign: 'center' }}>
              <div style={{ fontSize: 'clamp(22px, 3vw, 30px)', fontWeight: 700, color: '#fff', lineHeight: 1.2 }}>
                {s.num}
              </div>
              <div style={{
                fontSize: '14px', color: 'rgba(255,255,255,0.6)',
                textTransform: 'uppercase', letterSpacing: '0.7px', marginTop: '4px',
              }}>
                {s.label}
              </div>
            </div>
